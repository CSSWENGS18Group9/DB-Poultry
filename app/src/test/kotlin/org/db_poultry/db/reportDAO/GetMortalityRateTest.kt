...
class GetMortalityRateTest {
    ...
    @Test
    fun testGetMortalityRateForFlockWithValidInput() {
    ...
    @Test
    fun testGetMortalityRateForFlockWithWrongDate() {
        val flockOneDate = Date.valueOf("1000-01-01")
        val flockTwoDate = Date.valueOf("1000-06-01")
        val fdDateOne = Date.valueOf("1000-02-01")
        val fdDateTwo = Date.valueOf("1000-03-01")
        ...
        val result = GetMortalityRate.calculateMortalityRateForFlock(conn, fdDateOne)

        assertNull(result)
    }

    @Test
    fun testGetMortalityRateForFlockNoFlockDetails() {
        val flockOneDate = Date.valueOf("1000-01-01")
        val flockTwoDate = Date.valueOf("1000-06-01")
        val fdDateOne = Date.valueOf("1000-02-01")
        val fdDateTwo = Date.valueOf("1000-03-01")
    ...
    @Test
    fun testGetMortalityRateForFlockNoData() {
        val flockOneDate = Date.valueOf("1000-01-01")
        val flockTwoDate = Date.valueOf("1000-06-01")

        val result = GetMortalityRate.calculateMortalityRateForFlock(conn, flockTwoDate)
    ...
    @Test
    fun testGetMortalityRateForFlockDateWithValidInput() {
        val flockOneDate = Date.valueOf("1000-01-01")
        val flockTwoDate = Date.valueOf("1000-06-01")
        val fdDateOne = Date.valueOf("1000-02-01")
        val fdDateTwo = Date.valueOf("1000-03-01")
        ...
        val resultTwo = GetMortalityRate.calculateMortalityRateForFlockDate(conn, flockTwoDate, fdDateFour)
    ...
    @Test
    fun testGetMortalityRateForFlockDateWithSameStartandEndDate() {
        val flockOneDate = Date.valueOf("1000-01-01")
        val flockTwoDate = Date.valueOf("1000-06-01")
        val fdDateOne = Date.valueOf("1000-02-01")
        val fdDateTwo = Date.valueOf("1000-03-01")
    ...
    @Test
    fun testGetMortalityRateForFlockDateWithOverlappingDates() {
        val flockOneDate = Date.valueOf("1000-01-01")
        val flockTwoDate = Date.valueOf("1000-06-01")
        val fdDateOne = Date.valueOf("1000-02-01")
        val fdDateTwo = Date.valueOf("1000-03-01")
        ...
        val result = GetMortalityRate.calculateMortalityRateForFlockDate(conn, flockOneDate, fdDateFour)

        assertNull(result)
    }

    @Test
    fun testGetMortalityRateForFlockDateWithNoFlockDetails() {
        val flockOneDate = Date.valueOf("1000-01-01")
        val fdDateTwo = Date.valueOf("1000-03-01")
    ...
    @Test
    fun testGetMortalityRateForFlockDateWithNoData() {
        val flockOneDate = Date.valueOf("1000-01-01")
        val fdDateTwo = Date.valueOf("1000-03-01")
